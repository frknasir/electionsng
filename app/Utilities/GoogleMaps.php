...
class GoogleMaps{
    ...
    */
    public static function geocodeAddress( $state, $localgovernment ){
        /*
        Builds the URL and request to the Google Maps API
        */
        $url = 'https://maps.googleapis.com/maps/api/geocode/json?address='.urlencode( $localgovernment.' '.$state.' Nigeria' ).'&key='.env( 'GOOGLE_MAPS_KEY' );
