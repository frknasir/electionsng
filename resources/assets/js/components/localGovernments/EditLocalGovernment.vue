                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form v-show="show_form">
                                ...
                                <button v-if="updateLocalGovernmentLoadStatus != 1" @click="editLocalGovernment(lg)" type="button" 
                                    class="btn btn-success">
                                    Submit
                                </button>
                                <action-loader class="text-left" :loading='updateLocalGovernmentLoadStatus == 1' 
